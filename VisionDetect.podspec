#
#  Be sure to run `pod spec lint VisionDetect.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "VisionDetect"
  s.version      = "1.0.2"
  s.summary      = "VisionDetect let you track user face gestures like blink, smile etc."
  ...
  s.source_files  = "VisionDetect", "VisionDetect/**/*.{h,m}"
